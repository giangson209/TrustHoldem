    ...
    return (
        <div className="bg-[#0F0F0F] p-4 rounded-32 relative h-full border-0">
            ...
            <div className="blockPanel relative z-2 w-full">
                <div className="relative bg-[#1E1E1E] rounded-[32px_32px_0_0] px-5 py-4.5 border border-b-0 border-solid border-[#282828]">
                    <div className="text-22 text-white font-semibold flex items-center justify-between">
                        <span>홍길동 회원님 안녕하세요.</span>
                        <a href="" className="text-gold font-semibold text-16 font-bold inline-flex px-6 py-1.5 border border-yellow rounded-32 bg-[#000000] transition-all hover:scale-[1.04]">로그아웃</a>
                    </div>
                </div>
                            ...
                            <li className="flex items-center gap-4 font-bold mb-0">
                                <div className="flex flex-wrap text-yellow gap-3 mt-4">
                                    <button
                                        ...
                                        className="border border-2 border-yellow px-9 py-3 text-black rounded-full font-semibold min-w-41 transition-all hover:scale-[1.04] bg-gradient"
                                    >
                                        골드충전
                                    </button>
                                    <button
                        ...
                        <svg className="w-[auto] h-full inline ml-auto" viewBox="0 0 315 73" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <defs>
                                <linearGradient id="paint0_linear_11580_5559" x1="250.852" y1="-6.73941e-07" x2="250.852" y2="73" gradientUnits="userSpaceOnUse">
                                    <stop stopColor="#D7A62B" stopOpacity="0"/>
                                    <stop offset="1" stopColor="#D7A62B" stopOpacity="0.2"/>
                                </linearGradient>
                            </defs>
                        </svg>
                    </div>
