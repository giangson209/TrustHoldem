        ...
        <div className="bg-[#0F0F0F] border-gradient p-4 rounded-32 relative h-full">
            ...
            <div className="blockPanel relative z-2 w-full">
                <div className="relative bg-[#1E1E1E] rounded-[24px_24px_0_0] 2xl:rounded-[32px_32px_0_0] px-5 py-3 2xl:py-4 3xl:py-5 border border-b-0 border-solid border-[#282828]">
                    ...
                    <div className="close absolute top-2 right-1 cursor-pointer">
                ...
                <div className="relative rounded-[0_0_24px_24px] 2xl:rounded-[0_0_32px_32px] border border-t-0 border-solid border-[#282828] overflow-hidden">
                    <div className="relative top-0 left-0 w-full h-full flex items-center px-6 py-3 2xl:py-4 4xl:py-6">
                ...
                <div className="mt-3 2xl:mt-4">
                    <div className="grid grid-cols-12 gap-6 px-5 mb-4 last:mb-0">
                        ...
                        <div className="item col-span-6">
                            <input type="text" placeholder="숫자만 입력" className="w-full h-8 xl:h-9 3xl:h-10 4xl:h-12 px-4 border border-solid border-[#FFFFFF80] rounded-40 font-regular text-15 3xl:text-16"/>
                        </div>
                        <div className="item col-span-3">
                            <button className="text-yellow font-semibold text-center h-8 xl:h-9 3xl:h-10 4xl:h-12 rounded-40 border border-[1.5] border-solid border-yellow w-full !itransition-all hover:text-black hover:bg-yellow">보관하기</button>
                        </div>
                    </div>
                    <div className="grid grid-cols-12 gap-6 px-5 mb-4 last:mb-0">
                        <div className="item col-span-3">
                        ...
                        <div className="item col-span-3">
                            <button className="text-yellow font-semibold text-center h-8 xl:h-9 3xl:h-10 4xl:h-12 rounded-40 border border-[1.5] border-solid border-yellow w-full !itransition-all hover:text-black hover:bg-yellow">꺼내기</button>
                        </div>
                    </div>
                </div>
            </div>
